...
logging.basicConfig(filename='selenium_logs.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
try:
    ...
    try:
        # Exemplo: Verificar se o campo de login está presente
